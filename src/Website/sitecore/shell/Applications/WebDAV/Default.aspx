...
<body onload="window.setTimeout(function() { document.getElementById('OpenDAVView').click();}, 50)">
  ...
  <div id="MainPanel">
    <div class="defaultmessage">
      <%= Sitecore.Globalization.Translate.Text("Please wait while Drag & Drop view is loaded. If view does not appear, your browser may not support WebDAV protocol.") %></div>
