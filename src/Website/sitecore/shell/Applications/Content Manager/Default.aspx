...
<body runat="server" id="Body" class="scWindowBorder1"
  ...
  <form id="ContentEditorForm" runat="server"><sc:CodeBeside runat="server" Type="Sitecore.Shell.Applications.ContentManager.ContentEditorForm,Sitecore.Client"/><sc:DataContext runat="server" id="ContentEditorDataContext" /><sc:RegisterKey runat="server" KeyCode="120" Click="system:publish" />
  ...
  <span id="scPostActionText" style="display:none"><sc:Literal Text="The main window could not be updated due to the current browser security settings. You must click the Refresh button yourself to view the changes." runat="server" /></span>
                                                                                                                                          
  <asp:ScriptManager ID="ScriptManager1" runat="server" />                                 
  <telerik:RadSpell ID="RadSpell" runat="server"/>

  <iframe id="overlayWindow" src="/sitecore/shell/Controls/Rich Text Editor/EditorWindow.aspx" style="position: absolute; width: 100%; height: 100%; top: 0px; left: 0px; right: 0px; bottom: 0px; display: none; z-index: 999;border:none" frameborder="0" allowtransparency="allowtransparency"></iframe>
  ...
  <table class="scPanel scWindowBorder2" cellpadding="0" cellspacing="0" border="0" onactivate="javascript:scWin.activate(this, event)">
    <tr>                                                                    
      <td class="scCaption scWindowHandle scDockTop" ondblclick="javascript:scWin.maximizeWindow()" valign="top">
        <div id="CaptionTopLine"><img src="/sitecore/images/blank.gif" width="1" height="1" alt="" /></div>
    ...
    <tr>
      <td id="MainPanel" class="scDockMain" onclick="javascript:scContent.onEditorClick(this, event)" valign="top">
        
        <table class="scPanel" cellpadding="0" cellspacing="0" border="0">
          <tr>
            <td class="scWindowBorder3" width="2"><img src="/sitecore/images/blank.gif" class="scWindowBorder4" alt="" /></td>
              ...
              <table width="100%" height="100%" cellpadding="0" cellspacing="0" border="0">
                <tr id="SearchPanel" runat="server">
                  <td style="background:#e9e9e9;border-bottom:1px solid #4c4c4c">
                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                      <tr>
                        <td style="width:100%;overflow: hidden;padding:1px 0px 1px 2px" runat="server">
                          <input id="TreeSearch" class="scSearchInput scIgnoreModified" style="color:#999999" value="<%=Translate.Text(Texts.SEARCH) %>" onkeydown="javascript:if(event.keyCode==13)return scForm.postEvent(this,event,'TreeSearch_Click',true)" onfocus="javascript:scContent.watermarkFocus(this,event)" onblur="javascript:scContent.watermarkBlur(this,event)" />
                        </td>
                        <td style="padding:0px 0px 0px 0px">
                          <a href="#" class="scSearchButton" onclick="javascript:return scForm.postEvent(this,event,'TreeSearch_Click',true)">
                            <sc:ThemedImage runat="server" Src="Applications/16x16/view.png" width="16" height="16" margin="0px 1px 0px 1px"/>
                          </a>
                        </td>
                    ...
                    <table id="TreeSearchOptions" width="100%" cellpadding="0" cellspacing="0" border="0" style="display:none;table-layout:fixed;padding:4px 2px 2px 2px;border-top:1px solid #414851">
                      <tr>
                        <td>
                          <table id="SearchOptionsList" width="100%" cellpadding="0" cellspacing="0" border="0" onkeydown="javascript:if(event.keyCode==13)return scForm.postEvent(this,event,'TreeSearch_Click',true)">
                            <col align="right"/>
                            <col width="100%" />
                            <tr>
                              <td class="scSearchOptionsNameContainer"><a id="SearchOptionsControl0" href="#" class="scSearchOptionName" onclick="javascript:return scForm.postEvent(this,event,'TreeSearchOptionName_Click',true)"><sc:Literal Text="Name:" runat="server"/></a></td>
                              <td class="scSearchOptionsValueContainer"><input id="SearchOptionsValue0" class="scSearchOptionsInput scIgnoreModified" /><input id="SearchOptionsName0" type="hidden" value="_name" /></td>
                            </tr>
                            <tr>
                            <td valign="top" style="padding:12px 0px 0px 0px">
                              <a href="#" class="scSearchAddCriteria" onclick="javascript:return scContent.addSearchCriteria(this,event)"><sc:ThemedImage Src="Applications/16x16/view_add.png" Width="16" Height="16" runat="server" Align="absmiddle" Style="margin:0px 4px 0px 0px"/><sc:Literal Text="Add Criteria" runat="server" /></a>
                            </td>
                            <td valign="top" class="scSearchOptionsValueContainer scSearchAddCriteriaInput" runat="server">
                              <input id="SearchOptionsAddCriteria" class="scSearchOptionsInput scIgnoreModified"style="color:#999999"  value="<%=Translate.Text(Texts.FIELD1) %>" onkeydown="javascript:if(event.keyCode==13)return scContent.addSearchCriteria(this,event)" onfocus="javascript:scContent.watermarkFocus(this,event)" onblur="javascript:scContent.watermarkBlur(this,event)"/>
                            </td>
                            </tr>
                          </table>
                        </td>
                      ...
                      <tr>
                        <td class="scSearchHeader">
                          <a href="#" style="float:right" onclick="javascript:return scContent.closeSearch(this,event)">
                            <sc:ThemedImage runat="server" Src="Images/close.png" width="16" height="16" margin="0px 4px 0px 0px" RollOver="true" />
                          </a>
                          <sc:ThemedImage runat="server" Src="Applications/16x16/view.png" width="16" height="16" Align="absmiddle"/>
                          <span ID="SearchResultsHeader" />
                        </td>
                      </tr>
                      <tr><td height="100%"><div id="SearchResult" style="background:white;height:100%;overflow:auto"></div></td></tr>
                    </table>
                  </td>
                </tr>
                
                <tr id="ContentTreeHolder"><td valign="top" style="height:100%"><div class="scContentTreeContainer" style="height:100%"><asp:PlaceHolder ID="ContentTreePlaceholder" runat="server" /></div></td></tr>
              </table>
              </div> <!-- /scFixSize -->
            </td>
            
            <td id="ContentTreeSplitter" class="scSplitter" width="7"
                onmousedown="javascript:return scContent.mouseDown(this, event)"
                onmousemove="javascript:return scContent.mouseMove(this, event)"
                onmouseup="javascript:return scContent.mouseUp(this, event)">
