...
<body onload="javascript:onLoad()">
    ...
    <table width="100%" height="100%" cellpadding="0" cellspacing="0" border="0" >
      ...
      <tr>
        <td height="100%">
          ...
          <cc2:StiWebDesigner id="Designer" runat="server" OnSaveReport="Designer_SaveReport"  />    
  ...
  <script language="javascript" type="text/javascript">
    ...
    function scSaveFilter() {
      return window.parent.scForm.postRequest("", "", "", "SaveFilter_Click");
    }
