...
Object.extend(String.prototype, (function() {
  ...
  return {
    ...
    isJSON:         isJSON,
    //Modified by ANS. The native JSON parser incorrectly parses some objects. TODO: REMOVE IN RELEASE.
  ...
  if ('getBoundingClientRect' in document.documentElement) {
    Element.addMethods({
      ...
      cumulativeOffset: function(element) {
        ...
        //Modified by ANS. The cumulative offset is incorrect in RC. TODO: REMOVE IN RELEASE
        //return elementOffset.relativeTo(docOffset);
        var offset = elementOffset.relativeTo(docOffset);
        var body = document.body
  	    var docElem = document.documentElement;	     
	      var scrollTop = window.pageYOffset || docElem.scrollTop || body.scrollTop;
        var scrollLeft = window.pageXOffset || docElem.scrollLeft || body.scrollLeft;
        return new Element.Offset(offset.left + scrollLeft, offset.top + scrollTop);
  },
