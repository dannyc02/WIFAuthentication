...
<html style="overflow:hidden; width: 100%; height: 100%">
  <head runat="server">
    ...
    <script type="text/javascript" language="javascript">
      ...
      {
        $("EditorValue").value = scRichText.getEditor().get_html(true);
  ...
  <body style="height: 100%; width: 100%;background:#ececec">
    <form runat="server" id="mainForm" style="width:100%; height: 100%">
      ...
      <div id="scButtons" style="position: absolute; right: 8px; bottom: 1px">
        <sc:Button runat="server" ID="OkButton" Width="76px" Height="23px" KeyCode="13" Margin="0px 0px 0px 4px" Click="javascript:scSendRequest(event, \'editorpage:accept\')" Type="Button">
